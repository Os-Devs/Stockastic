...
namespace Stockastic.Migrations
{
    ...
    [Migration("20231022191953_quarta")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stockastic.Models.Produto", b =>
                {
                    ...
                    b.Property<int>("UsuarioAssociadoId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UsuarioAssociadoId");
            ...
            modelBuilder.Entity("Stockastic.Models.Produto", b =>
                {
                    b.HasOne("Stockastic.Models.Usuario", "UsuarioAssociado")
                        .WithMany()
                        .HasForeignKey("UsuarioAssociadoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
